...
<html lang="en">
    ...
    <div class="navbar-inner">
        ...
        <a class="brand" href=""{{ url('/dashboard') }}""><span class="first">Rubus</span> <span class="second">Data</span></a>
    </div>
</div>
    ...
    <div class="dialog">
        <div class="block">
            ...
            <div class="block-body">
                ...
                <a href="{{ url('/dashboard') }}" class="btn btn-primary pull-right">Sign In</a>
