    ...
    public function __invoke(array $symbols): QuoteCollection
    {
        ...
        try {
            ...
            foreach ($symbols as $symbol) {
                ...
                $quoteCollection->add($this->quoteHydrator->hydrateFromCoinMarketCap(array_merge($resultRaw, $res)));
                $res['currency'] = 'EUR';
                $quoteCollection->add($this->quoteHydrator->hydrateFromCoinMarketCap(array_merge($resultConvert, $res)));
            }
